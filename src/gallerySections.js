...
const toggleClass = () =>
{
   setActive(!isActive);
    ...
    return (
          ...
          <section style={{backgroundImage: "url('https://drive.google.com/uc?id=1k7ZnzwBkz_5CRdQh0ctbol6QnAPlr0UP')"}} onClick={toggleClass} className={isActive ? 'activeArt' : null}></section>
         </>
      );
   }
